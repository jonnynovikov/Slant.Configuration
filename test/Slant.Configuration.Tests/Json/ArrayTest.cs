...
namespace Slant.Extensions.Configuration.Json.Test
{
    public class ArrayTest
    {
        ...
        public void ArraysAreConvertedToKeyValuePairs()
        {
            ...
            jsonConfigSource.Get("ip:0").Should().Be("1.2.3.4");
            jsonConfigSource.Get("ip:1").Should().Be("7.8.9.10");
            jsonConfigSource.Get("ip:2").Should().Be("11.12.13.14");
        }
        ...
        public void ImplicitArrayItemReplacement()
        {
            ...
            var jsonConfigSource1 = new JsonConfigurationSource { CreateStream = () => TestStreamHelpers.StringToStream(json1) };
            var jsonConfigSource2 = new JsonConfigurationSource { CreateStream = () => TestStreamHelpers.StringToStream(json2) };
        ...
        public void ArraysAreKeptInFileOrder()
        {
            ...
            var jsonConfigSource = new JsonConfigurationSource { CreateStream = () => TestStreamHelpers.StringToStream(json) };
